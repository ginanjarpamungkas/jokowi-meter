...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
        <li><a href="{{route('user.list')}}"><i class="fa fa-user"></i> User</a></li>
            ...
            <div class="col-xs-12">
                <div class="box box-danger">
                    <div class="box-header with-border">
                        <h3 class="box-title">Daftar User Janji Jokowi</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
        ...
        <div class="modal-content">
            ...
            <div class="register-box-body">
                ...
                <form action="{{ route('user.store') }}" method="post">
                    ...
                    <div class="form-group has-feedback">
                        <input placeholder="Divis" id="divisi" type="text" class="form-control{{ $errors->has('divisi') ? ' is-invalid' : '' }}" name="divisi" value="{{ old('divisi') }}" required>
