        ...
        <div class="box box-danger">
            ...
            <div class="box-body">
                <div class="table-responsive col-lg-6">
                    <table id="Topik" class="table table-hover">
                        <thead>
                            <tr>
                                <th>Nama Topik</th>
                                <th>Action</th>
                ...
                <form id="myForm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" id="nama" name="nama" class="form-control" placeholder="Nama Topik" required><br>
        ...
        jQuery('#submited').click(function(e){
            ...
            jQuery.ajax({
                ...
                success: function(data){
                    $('#Topik').append('<tr><td data-id="'+data.idB+'">'+data.namaB+'</td><td><button type="button" class="btn btn-sm btn-default Delete" data-id="'+data.idB+'" type="button" data-placement="top" data-toggle="tooltip" data-original-title="Delete"><i class="fa fa-trash-o"></i></button></td></tr>');
                    jQuery('#nama').val('');
                }});
            });
        });
