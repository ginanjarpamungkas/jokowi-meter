...
<head>
  ...
  <title>Janji Jokowi | Dashboard</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="{{url('/')}}" target="_blank" class="logo">
      ...
      <span class="logo-mini"><b>J</b>-J</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">Janji<b>JOKOWI</b></span>
    </a>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Powered by <a href="https://tempo.co" target="_blank">Tempo.co</a>.</strong> All rights reserved.
  </footer>
